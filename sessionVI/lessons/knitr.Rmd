...
In RMarkdown, programming chunks are defined by three backticks ("```") then the programming language, followed by a *unique* chunk label, and customization options.
