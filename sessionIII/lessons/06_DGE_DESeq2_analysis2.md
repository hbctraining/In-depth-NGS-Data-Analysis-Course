...
- **FDR / Benjamini-Hochberg:** Rank the genes by p-value, then multiply alpha by rank/m. Now evaluate those that have values less than the p-value to identify genes that reject the null hypothesis. This approach is designed to control the proportion of false positives among the set of rejected null hypotheses.
