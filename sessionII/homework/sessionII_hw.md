...
3. Use vim to create a script by copying and pasting the contents of [this page](https://steve-parker.org/sh/eg/var3.sh.txt). Call it `pos_param_test.sh`.
...
#### Releveling Factors
3. Use the `samplegroup` factor we created in class, and relevel it such that KO is the first level followed by CTL and OE.
